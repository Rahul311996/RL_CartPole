...
class Model:
    ...
    """
    def __init__(self, restore=False, restore_file=None):
        """
    ...
    def random_sampler(self, num_samples):
        ...
        for t in range(num_samples):
            ...
            data = np.array([prev_observation[0], prev_observation[1], prev_observation[2], action[0],
    ...
    def train_model(self, num_epochs, train_dataset, validation_dataset):
        ...
        while epoch <= num_epochs:
            ...
            if step % 100 == 0:
                ...
                stochastic_nstep_loss, _, _ = self.n_step_prediction_loss(10, 'stochastic_noise')
                self.n_step_loss_stochastic.load(stochastic_nstep_loss, self.sess)

                random_nstep_loss, _, _ = self.n_step_prediction_loss(10, 'random')
    ...
    def n_step_prediction_loss(self, n_steps=10, sampling_policy='stochastic_noise'):
        """
...
if __name__=='__main__':
    M=Model(False)
    for i in range(1):
        print(M.n_step_prediction_loss(10, 'random'))
